...
from movielens.page.views import page
from movielens.up.views import up
from movielens.extensions import db
from movielens.extensions import debug_toolbar
from movielens.extensions import flask_static_digest
