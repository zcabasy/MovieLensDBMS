...
- `movielens/initializers.py` now exists to define frequently used imports, variables, etc.
...
- `movielens/blueprints/` namespace has been removed
...
- Import `Redis` more efficiently in `movielens/extensions.py`
...
- Unnecessary `CELERY_TASK_LIST` comment in `movielens/app.py`, this was a left over copy / paste mishap
